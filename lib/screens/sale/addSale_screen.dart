...
class _addsalescreenState extends State<addsalescreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //                     _piecesProduct = products.firstWhere((product) =>
      //                         product['name'] == _nameProduct)['pieces'];
      //                     print(_nameProduct);
      //                     print(_priceProduct);
      //                   });
      //                 },
      //                 items: controller.datos.map((element) {
      ...
      //                 }
      //                 final enteredPieces = int.tryParse(value);
      //                 if (enteredPieces == null) {
      //                   return 'Please enter a valid integer';
      //                 }
      //                 if (enteredPieces > _piecesController.text.length) {
      //                   return 'Cannot exceed the maximum number of pieces';
      //                 }
      //                 return null;
      //               },
      ...
      //                   if (int.parse(value) < _piecesProduct!) {
      //                     _updateTotal();
      //                   }
      //                 } else {
